public class wrongvoter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nama dan NPM tidak cocok.");

        jLabel2.setFont(new java.awt.Font("Poppins", 0, 13)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Silahkan kembali dan coba lagi.");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new wrongvoter().setVisible(true);
            }
        });
    }
